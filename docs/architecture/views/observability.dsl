systemLandscape "RuntimeWithObservability" {
    title "Taxi-manager и Система хранения и анализа данных мониторинга"
    description "Показывает основное приложение со встроенным Коллектором наблюдаемости, внешнюю Систему хранения и анализа данных мониторинга и доставку email-оповещений Специалисту сопровождения. CI/CD и Система уведомлений менеджеров не показаны."
...
container taxiManager "ObservabilityContainers" {
    title "Диаграмма контейнеров наблюдаемости Taxi-manager"
