...
import taxi_manager.infrastructure.vehicle.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number_of_seats",
                    models.IntegerField(verbose_name="Количество посадочных мест"),
                ),
                (
                    "tank_capacity_l",
                    models.IntegerField(
                        help_text="Объем бака (л)", verbose_name="Объем бака"
                    ),
                ),
                (
                    "load_capacity_kg",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mileage",
                    models.IntegerField(help_text="Пробег (км)", verbose_name="Пробег"),
                ),
                (
                    "number",
                    models.CharField(
                        max_length=6, unique=True, verbose_name="Госномер"
                    ),
                ),
                (
                    "vin",
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            taxi_manager.infrastructure.vehicle.validators.vin_validator
                        ],
                        verbose_name="VIN",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.RESTRICT,
                        related_name="vehicle_driver_pairs",
                        to="enterprise.enterprise",
                        verbose_name="Предприятие",
                    ),
                ),
