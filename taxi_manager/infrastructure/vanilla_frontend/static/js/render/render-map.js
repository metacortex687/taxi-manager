...
const renderMapField = (field, entity, parentElement, eventData = { id: undefined }) => {
    ...
    const grayIconEnd = L.icon({
        iconUrl: "/static/vanilla_frontend/img/marker-gray-start.png",
    ...
    const greenIconEnd = L.icon({
        iconUrl: "/static/vanilla_frontend/img/marker-green-start.png",
        shadowUrl: "https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png",
        iconSize: [25, 41],
        iconAnchor: [12, 41],
        popupAnchor: [1, -34],
    ...
    const grayIconStart = L.icon({
        iconUrl: "/static/vanilla_frontend/img/marker-gray-end.png",
        shadowUrl: "https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png",
        iconSize: [25, 41],
        iconAnchor: [12, 41],
        popupAnchor: [1, -34],
    ...
    const greenIconStart = L.icon({
        iconUrl: "/static/vanilla_frontend/img/marker-green-end.png",
        shadowUrl: "https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png",
        iconSize: [25, 41],
        iconAnchor: [12, 41],
        popupAnchor: [1, -34],
